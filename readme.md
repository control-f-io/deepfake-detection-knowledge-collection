...
- ***Datasets***:
  ...
  - **HiFi-IFDL Dataset**: <br> A dataset for fine-grained forgery detection, with CNN-based synthetic images and forgery masks <br>

  - **CelebA-HQ**: <br> High-quality version of CelebA, featuring celebrity face images used in manipulation detection. <br>

  - **LSUN**: <br> Dataset with various object categories like scenes and vehicles. <br>
